...
public interface AidasProjectRepository extends JpaRepository<AidasProject, Long> {
    ...
    @Query(value="select * from aidas_project p, aidas_object o,  aidas_user_obj_map am ,aidas_user u where  am.aidas_object_id=o.id and o.aidas_project_id=p.id and am.aidas_user_id=u.id and u.id= ?1",nativeQuery = true)
    Page<AidasProject> findAllProjectsByVendorUser(Pageable page, AidasUser aidasUser);
    @Query(value="select * from aidas_project p, aidas_object o,  aidas_user_obj_map am ,aidas_user u where  am.aidas_object_id=o.id and o.aidas_project_id=p.id and am.aidas_user_id=u.id and u.aidas_vendor_id= ?1",nativeQuery = true)
    Page<AidasProject> findAllProjectsByVendorAdmin(Pageable page, AidasVendor aidasVendor);

    @Query(value="select * from aidas_project p, aidas_object o,  aidas_user_obj_map am ,aidas_user u where  am.aidas_object_id=o.id and o.aidas_project_id=p.id and am.aidas_user_id=u.id and u.id= ?1 and p.id=?2",nativeQuery = true)
    Optional<AidasProject> findAllProjectsByVendorUserProject(AidasUser aidasUser, Long aidasProjectId);
    @Query(value="select * from aidas_project p, aidas_object o,  aidas_user_obj_map am ,aidas_user u where  am.aidas_object_id=o.id and o.aidas_project_id=p.id and am.aidas_user_id=u.id and u.aidas_vendor_id= ?1 and p.id=?2",nativeQuery = true)

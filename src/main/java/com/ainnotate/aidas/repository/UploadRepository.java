...
public interface UploadRepository extends JpaRepository<Upload, Long> {
    ...
    @Query(value = "select * from upload au, user_vendor_mapping_object_mapping auavmaom,object ao where au.user_vendor_mapping_object_mapping_id=auavmaom.id and  auavmaom.object_id=ao.id and ao.project_id=?1 and au.approval_status=?2",nativeQuery = true)
    List<Upload>getAidasUploadsByProject(Long aidasProjectId, Integer approvalStatus);

    @Query(value = "select * from upload au, user_vendor_mapping_object_mapping auavmaom,object ao where au.user_vendor_mapping_object_mapping_id=auavmaom.id and auavmaom.object_id=ao.id and ao.project_id=?1",nativeQuery = true)
    List<Upload>getAidasUploadsByProject(Long aidasProjectId);

    @Query(value = "select * from upload au, user_vendor_mapping_object_mapping auavmaom where au.user_vendor_mapping_object_mapping_id=auavmaom.id and  auavmaom.object_id=?1 and au.approval_status=?2",nativeQuery = true)
    List<Upload>getAidasUploadsByObject(Long aidasProjectId, Integer approvalStatus);

    @Query(value = "select * from upload au, user_vendor_mapping_object_mapping auavmaom where au.user_vendor_mapping_object_mapping_id=auavmaom.id and  auavmaom.object_id=?1 ",nativeQuery = true)
    ...
    @Query(value="select * from upload au, user_vendor_mapping_object_mapping auavmaom, object ao, project ap, customer ac where au.user_vendor_mapping_object_mapping_id=auavmaom.id and auavmaom.object_id=ao.id and ao.project_id=ap.id and ap.customer_id=ac.id and ac.id=?1",nativeQuery = true)
    ...
    @Query(value="select * from upload au, user_vendor_mapping_object_mapping auavmaom,user_vendor_mapping auavm, user au1 where au.user_vendor_mapping_object_mapping_id=auavmaom.id and auavmaom.user_vendor_mapping_id=auavm.id and auavm.user_id=au1.id and auavm.vendor_id=?1",nativeQuery = true)
...
//For vendor user
    @Query(value="select count(*) from upload au, user_vendor_mapping_object_mapping auavmaom,user_vendor_mapping auavm where au.user_vendor_mapping_object_mapping_id=auavmaom.id and auavmaom.user_vendor_mapping_id=auavm.id and auavm.user_id=?1",nativeQuery = true)
    ...
    @Query(value="select * from upload au, user_vendor_mapping_object_mapping auavmaom,user_vendor_mapping auavm where au.user_vendor_mapping_object_mapping_id=auavmaom.id and auavmaom.user_vendor_mapping_id=auavm.id and auavm.user_id=?1 and auavmaom.object_id=?2",
    ...
    @Query(value="select * from upload au, user_vendor_mapping_object_mapping auavmaom,user_vendor_mapping auavm where au.user_vendor_mapping_object_mapping_id=auavmaom.id and auavmaom.user_vendor_mapping_id=auavm.id and auavm.user_id=?1 and auavmaom.object_id=?2 and au.approval_status=?3",
    ...
    @Query(value="select * from upload u, user_vendor_mapping_object_mapping uvmom, object o where u.user_vendor_mapping_object_mapping_id=uvmom.id and uvmom.object_id=o.id and o.project_id=?1 and u.qc_done_by_id is null and u.qc_status=0 and u.qc_end_date is null and qc_start_date is null limit 1",nativeQuery = true)

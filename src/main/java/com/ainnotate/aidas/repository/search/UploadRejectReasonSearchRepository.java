 ...
 */
public interface UploadRejectReasonSearchRepository
    extends ElasticsearchRepository<UploadRejectReason, Long>, UploadRejectReasonSearchRepositoryInternal {}

interface UploadRejectReasonSearchRepositoryInternal {
    Page<UploadRejectReason> search(String query, Pageable pageable);
}

class UploadRejectReasonSearchRepositoryInternalImpl implements UploadRejectReasonSearchRepositoryInternal {

    private final ElasticsearchRestTemplate elasticsearchTemplate;

    UploadRejectReasonSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {

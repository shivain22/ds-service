...
/**
 * Performance test for the AidasObjectProperty entity.
 */
class AidasObjectPropertyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AidasObjectProperty entity")

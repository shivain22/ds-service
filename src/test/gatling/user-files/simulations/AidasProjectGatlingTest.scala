...
/**
 * Performance test for the AidasProject entity.
 */
class AidasProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AidasProject entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all aidasProjects")
            .get("/services/ainnotateservice/api/aidas-projects")
            .headers(headers_http_authenticated)
            .check(status.is(200)))

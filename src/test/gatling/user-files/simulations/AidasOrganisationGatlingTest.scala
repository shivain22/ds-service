...
/**
 * Performance test for the AidasOrganisation entity.
 */
class AidasOrganisationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AidasOrganisation entity")
